...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--muted)] transition hover:border-[var(--accent-soft)]">
      <div className="h-1 bg-gradient-to-r from-[var(--accent-soft)] via-[var(--accent-warm)] to-transparent opacity-70" />
