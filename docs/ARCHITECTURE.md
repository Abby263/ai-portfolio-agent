...
| **Link Validation Agent**      | Confirms published project links are reachable after changes.      |
...
- `Project` — repo, live URL, summary, tech stack, highlights, screenshots.
...
MCP (Model Context Protocol) servers exist for GitHub and similar services — they expose tools that AI assistants like Claude Desktop or Cursor call locally on the user's machine. We chose **direct REST** in this product for three reasons:
